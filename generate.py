...
def build_strategy_notes(wb):
    ...
    sections = [
        ...
        ("CROYDON BASE — TERRITORY PRIORITISATION", [
            "Romell is Croydon-based. The operator doing weekly restocks lives SE London.",
            "This changes the territory ranking completely — route efficiency depends on proximity to base.",
            "",
            "DECISION: Prioritise the Croydon corridor over Park Royal (NW10) and Brimsdown (EN3).",
            "",
            "  Beddington Lane:        2 miles from Croydon — home turf",
            "  Purley Way leisure:      3 miles — same corridor",
            "  Kimpton, Sutton:         5 miles — quick run south",
            "  Crayfields, Orpington:   8 miles — expansion east",
            "  Park Royal:             12 miles, wrong side of London — deprioritised",
            "  Manor Royal, Crawley:   25 miles south — day trip, not daily route",
            "",
            "Park Royal is the best market but Beddington is the best business decision.",
            "Revenue per operator-HOUR matters more than revenue per machine.",
        ]),
        ("TEMPORAL CAPTIVITY — BEYOND INDUSTRIAL ESTATES", [
            "Industrial estates are 'spatial captivity' — workers can't walk to food.",
            "But there's a second type: 'temporal captivity' — people stuck for a time window.",
            "",
            "  Gyms:             Post-workout, sweaty, want protein NOW. 1-2hr window.",
            "  Car dealerships:   Waiting 1-4hrs for service. Bored, nothing to do.",
            "  Trampoline parks:  Kids on trampolines for 2hrs. Parents buy snacks.",
            "  Soft play:         Same as above. Impulse buying from captive parents.",
            "  Climbing walls:    Thirsty + hungry after. Water + protein bars.",
            "",
            "These aren't food deserts — there are shops nearby. But people can't or won't leave.",
            "The Purley Way corridor combines both: Beddington Lane (spatial) + Oxygen/Kidspace (temporal).",
            "",
            "DECISION: Mix location types along the same restock route.",
            "One trip serves industrial units AND gyms AND leisure venues AND dealerships.",
        ]),
        ("THE CROYDON CORRIDOR — TARGET ROUTE", [
            "16 pre-qualified leads in the Location Tracker, all on one route:",
            "",
            "  1. Beddington Lane industrial (3 sites) — spatial captivity",
            "  2. Purley Way dealerships (3 sites) — temporal captivity",
            "  3. Purley Way leisure (Oxygen, Kidspace, CroyWall) — temporal captivity",
            "  4. Kings Gym / WIZFIT (2 gyms on route) — temporal captivity",
            "  5. Gym Beast, Snap Fitness (2 more gyms nearby) — temporal captivity",
            "  6. Kimpton Industrial Estate (1 site, Sutton) — spatial captivity",
            "  7. Airjump + Fordes Gym (Orpington, expansion) — temporal captivity",
            "",
            "5-7 sites achievable in phase 1. All within 30 minutes driving of Croydon.",
            "Est. weekly revenue: £1,200-1,800 across the cluster.",
        ]),
